        ...
        <Col size="md-6">
          <MainContainer id="homecontainer">
            <Container id="textarea">
              ...
              <p>Hello! I'm <b>Shelby Kelly</b>, a full-stack web developer located in Hickory, North Carolina. I have a passion for making the web a more fun and interactive place to be.
              </p>
