...
const items = [
    ...
    <div className="item" data-value="2">
        <img src={ssprev} class="responsive" alt="Suite Skin Preview"></img>
            <h1>Suite Skin</h1>
            <h3>Github</h3>
            <p>A small business owner who was looking to upgrade from their Wix website, for their site to be Search Engine Optimized, and to display personal success before and after photos. This site features React, Bootstrap, HTML and CSS methods such as keyframes, animate and transform.</p>
        </div>,
];
